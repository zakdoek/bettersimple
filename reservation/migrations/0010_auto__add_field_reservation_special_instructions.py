...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.special_instructions'
        db.add_column('reservation_reservation', 'special_instructions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.special_instructions'
        db.delete_column('reservation_reservation', 'special_instructions')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c6219333-7661-4234-8d48-05931f53d836'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'933f0ef3-0d20-408c-96bc-b5c4406dbe2d'", 'max_length': '36'})
        },
        'reservation.trip': {
