...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ClientLandmark', fields ['name']
        db.delete_unique('reservation_clientlandmark', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'ClientLandmark', fields ['name']
        db.create_unique('reservation_clientlandmark', ['name'])
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'586f4e4f-e08a-4e16-b193-47067a7ef7ec'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8a863b87-da66-4238-afe8-18a7d1f45588'", 'max_length': '36'})
        },
        'reservation.trip': {
