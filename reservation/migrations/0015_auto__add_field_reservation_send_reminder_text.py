...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.send_reminder_text'
        db.add_column('reservation_reservation', 'send_reminder_text',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.send_reminder_text'
        db.delete_column('reservation_reservation', 'send_reminder_text')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'33ad7b64-1585-44aa-9a0c-45e6bca0c741'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'send_reminder_text': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'special_instructions': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f62d5de6-a306-4c0e-9e22-b292e4cfd56e'", 'max_length': '36'})
        },
        'reservation.trip': {
            ...
            'dropoff_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 17, 0, 0)'}),
