...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientLandmark.company'
        db.add_column('reservation_clientlandmark', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientservice.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientLandmark.company'
        db.delete_column('reservation_clientlandmark', 'company_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'07db13de-5647-41f0-8cb6-77de470f8ff9'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0a90c744-d930-428e-93f0-55b3a9b31347'", 'max_length': '36'})
        },
        'reservation.trip': {
