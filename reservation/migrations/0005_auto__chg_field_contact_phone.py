...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reservation_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=13))

    def backwards(self, orm):

        # Changing field 'Contact.phone'
        db.alter_column('reservation_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15afa1ae-48ec-4e88-a05d-9596b9438db2'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ab2193ce-e212-4d45-8cc6-02e2657334c9'", 'max_length': '36'})
        }
    }
