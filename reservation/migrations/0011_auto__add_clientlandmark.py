...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reservation_clientlandmark', (
        ...
        db.send_create_signal('reservation', ['ClientLandmark'])


    def backwards(self, orm):
        # Deleting model 'ClientLandmark'
        db.delete_table('reservation_clientlandmark')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2071e706-0ce8-41f8-a0d0-cb0f0ea267dd'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'26e341dc-38a5-4145-a147-e5989533aa8e'", 'max_length': '36'})
        },
        'reservation.trip': {
