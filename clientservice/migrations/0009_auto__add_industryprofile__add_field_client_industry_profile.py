...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clientservice_industryprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reservation_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('use_special_instructions', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_passengers', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('clientservice', ['IndustryProfile'])

        # Adding field 'Client.industry_profile'
        db.add_column('clientservice_client', 'industry_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['clientservice.IndustryProfile'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IndustryProfile'
        db.delete_table('clientservice_industryprofile')

        # Deleting field 'Client.industry_profile'
        db.delete_column('clientservice_client', 'industry_profile_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'industry_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['clientservice.IndustryProfile']", 'unique': 'True', 'null': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3a93ae70-4edf-4198-8a66-fe7beae5de5b'", 'max_length': '36'}),
