...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clientservice_client', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='0b6d911b-4d95-4a2b-bc24-6b36c8e633b5', max_length=36)),
        ))
        ...
        db.create_table('clientservice_clientcode', (
            ...
            ('head_code', self.gf('django.db.models.fields.TextField')(default='<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>')),
            ('link_code', self.gf('django.db.models.fields.TextField')(default='<a href="mailto:#"></a>')),
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6988db77-2b8f-4732-8d13-1491dcdcd540'", 'max_length': '36'}),
        ...
        'clientservice.clientcode': {
            ...
            'head_code': ('django.db.models.fields.TextField', [], {'default': '\'<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>\''}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'link_code': ('django.db.models.fields.TextField', [], {'default': '\'<a href="mailto:#"></a>\''})
        },
