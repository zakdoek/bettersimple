...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # blows away data. Be careful when using it.
        # Removing old M2M table for field landmarks on 'Client'
        ...
        db.create_table('clientservice_client_landmarks', (
            ...
            ('clientlandmark', models.ForeignKey(orm['reservation.clientlandmark'], null=False))
        ))
        db.create_unique('clientservice_client_landmarks', ['client_id', 'clientlandmark_id'])
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c0faddf6-5943-4657-a6ed-374b5d5a63ff'", 'max_length': '36'}),
