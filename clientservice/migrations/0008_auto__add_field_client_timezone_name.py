...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.timezone_name'
        db.add_column('clientservice_client', 'timezone_name',
                      self.gf('django.db.models.fields.CharField')(default='America/Denver', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.timezone_name'
        db.delete_column('clientservice_client', 'timezone_name')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'timezone_name': ('django.db.models.fields.CharField', [], {'default': "'America/Denver'", 'max_length': '100'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'31ade7c7-5006-4afc-9039-f637bcb73a7a'", 'max_length': '36'}),
