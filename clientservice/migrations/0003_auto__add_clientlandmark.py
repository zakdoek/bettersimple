...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a87b83fc-8e05-4dfb-a51c-01ea585681f8'", 'max_length': '36'}),
        ...
        'clientservice.clientlandmark': {
            'Meta': {'object_name': 'ClientLandmark'},
            'client': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['clientservice.Client']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'landmark': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reservation.Landmark']"})
        },
