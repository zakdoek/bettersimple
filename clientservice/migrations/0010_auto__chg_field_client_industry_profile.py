...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.industry_profile'
        db.alter_column('clientservice_client', 'industry_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['clientservice.IndustryProfile'], unique=True))

    def backwards(self, orm):

        # Changing field 'Client.industry_profile'
        db.alter_column('clientservice_client', 'industry_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['clientservice.IndustryProfile'], unique=True, null=True))
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0d38da3d-77e1-44d1-8ed5-6e485128aefe'", 'max_length': '36'}),
