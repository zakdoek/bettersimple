...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.charge_profile'
        db.add_column('clientservice_client', 'charge_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['charge.ClientChargeProfile'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.charge_profile'
        db.delete_column('clientservice_client', 'charge_profile_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'charge_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['charge.ClientChargeProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'88d9faf7-9d79-4f5f-8df7-1b83b9c7bdf2'", 'max_length': '36'}),
