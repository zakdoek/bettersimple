...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.monthly_charge'
        db.add_column('message_message', 'monthly_charge',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['charge.MonthlyCharge'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.monthly_charge'
        db.delete_column('message_message', 'monthly_charge_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e1f7aa88-1143-4ae6-8fa0-b0ef98b17090'", 'max_length': '36'}),
        ...
        'message.message': {
            ...
            'send_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 0, 0)'}),
        ...
        'reservation.reservation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'17d77891-402c-4d4b-9547-1ecd745c80e7'", 'max_length': '36'})
        }
    }
