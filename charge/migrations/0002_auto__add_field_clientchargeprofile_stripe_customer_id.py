...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientChargeProfile.stripe_customer_id'
        db.add_column('charge_clientchargeprofile', 'stripe_customer_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientChargeProfile.stripe_customer_id'
        db.delete_column('charge_clientchargeprofile', 'stripe_customer_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'04559a4a-d01f-40ed-9fbe-826e816e696c'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'dropoff_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pickup_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 29, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d999c7a8-97ae-410e-bcdc-efbde17787ca'", 'max_length': '36'})
        }
    }
