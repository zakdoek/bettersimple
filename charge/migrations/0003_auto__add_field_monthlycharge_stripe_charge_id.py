...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonthlyCharge.stripe_charge_id'
        db.add_column('charge_monthlycharge', 'stripe_charge_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MonthlyCharge.stripe_charge_id'
        db.delete_column('charge_monthlycharge', 'stripe_charge_id')
    ...
    models = {
        ...
        'clientservice.client': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'21f38a68-bbb9-4bec-9bf3-4af9060ce162'", 'max_length': '36'}),
        ...
        'reservation.reservation': {
            ...
            'dropoff_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pickup_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5a99d801-ca11-437e-8c51-b3c4cb06562a'", 'max_length': '36'})
        }
    }
